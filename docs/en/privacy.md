...
Trace evidence is designed for replay without exposing raw private facts. It includes request context, PowerContext query details, selected memory IDs, reason codes, vehicle diffs, and write results.
